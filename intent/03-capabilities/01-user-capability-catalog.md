...
The dated evidence for how the associated benchmark families moved during the preceding year is maintained separately in [agent benchmark velocity](../02-model/04-benchmark-velocity.md) and [benchmark-timeseries.csv](../../data/sources/benchmark-timeseries.csv). This keeps the capability ontology stable while benchmark versions and frontier models change.
...
The structured catalog is in [user-capability-catalog.csv](../../data/sources/user-capability-catalog.csv). Its 34 capabilities fall into six layers.
