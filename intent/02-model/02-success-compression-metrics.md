...
The current snapshot reconstructs the latest state of every covered U.S. site at each quarterly cutoff, rising from **0.246 million H100e in 2024-Q1 to 13.524 million on 26 August 2026**. The base forward path uses Epoch's dated expected/projected site states rather than extending a historical doubling-time regression. Its mean projected log growth is **0.243791 log₂ H100e per quarter**, and the slope of projected quarterly log growth is **0.003373 log₂ H100e per quarter²**. These derived values will change when Epoch revises site timelines. [Epoch timeline CSV](https://epoch.ai/data/data_centers/data_center_timelines.csv)
