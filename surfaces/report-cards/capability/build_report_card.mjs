...
const catalog = [
  ...
  ["DES-05", categories[0], "EnterpriseArena", "Best-model full-horizon survival rate", "Already a 0–100% rate; use frontier survival", "Graded", "2026-Q1", "https://arxiv.org/abs/2603.23638", "132-month CFO simulator; current point has limited-run uncertainty."],
  ...
  ["OPS-01", categories[1], "AutomationBench", "Public 600-task pass rate, max reasoning", "Already a 0–100% pass rate; compare within the public task version", "Graded", "2026-Q2", "https://github.com/zapier/AutomationBench", "Private leaderboard differs; this report uses the public 600-task table."],
  ["OPS-02", categories[1], "EnterpriseOps-Gym", "Strict task success across enterprise workflows", "Already a 0–100% success rate; all verifier conditions must pass", "Graded", "2025-Q2", "https://github.com/ServiceNow/EnterpriseOps-Gym", "Stateful planning, policy, side effects, and safe refusal."],
  ...
  ["PER-03", categories[2], "ClawBench", "Standardized personal-agent task score", "Already a 0–100% score; pin benchmark repo/version", "Graded", "2026-Q2", "https://github.com/TIGER-AI-Lab/ClawBench", "Personal-agent and computer-use signal; one public frontier point."],
  ["PER-04", categories[2], "AssistantBench", "Assistant task accuracy", "Already a 0–100% score; later HAL result marked as updated configuration", "Graded", "2024-Q3", "https://assistantbench.github.io/", "Realistic web research and personal-assistant tasks."],
...
const observations = [
  ...
  ["DES-05", "2026-03-20", "2026-Q1", 9, 0.80, "Qwen 3.5 9B", "Best-model full-horizon survival", "https://arxiv.org/abs/2603.23638", "Single launch-era frontier; flat forecast until another comparable point."],
  ...
  ["OPS-01", "2026-06-09", "2026-Q2", 10, 0.4617, "Claude Fable 5", "Public 600-task pass rate, max reasoning", "https://github.com/zapier/AutomationBench", "Score rerun under the July 2026 stricter classifier."],
  ["OPS-01", "2026-07-24", "2026-Q3", 11, 0.5030, "Claude Opus 5", "Public 600-task pass rate, max reasoning", "https://github.com/zapier/AutomationBench", "Current public frontier."],
  ["OPS-02", "2025-06-17", "2025-Q2", 6, 0.200, "Gemini 2.5 Pro", "Strict task success", "https://enterpriseops-gym.github.io/", "Release-quarter frontier."],
  ["OPS-02", "2025-09-29", "2025-Q3", 7, 0.341, "Claude Sonnet 4.5", "Strict task success", "https://enterpriseops-gym.github.io/", "Release-quarter frontier."],
  ["OPS-02", "2025-11-24", "2025-Q4", 8, 0.394, "Claude Opus 4.5", "Strict task success", "https://enterpriseops-gym.github.io/", "Release-quarter frontier."],
  ["OPS-02", "2026-02-05", "2026-Q1", 9, 0.459, "Claude Opus 4.6", "Strict task success", "https://enterpriseops-gym.github.io/", "Release-quarter frontier."],
  ["OPS-02", "2026-07-01", "2026-Q3", 11, 0.511, "Claude Fable 5 + fallback", "Strict task success", "https://enterpriseops-gym.github.io/", "Harness includes fallback; pin this configuration for future comparison."],
  ...
  ["PER-03", "2026-06-01", "2026-Q2", 10, 0.333, "Current top system", "Standardized ClawBench score", "https://github.com/TIGER-AI-Lab/ClawBench", "One public frontier point; pin repository version."],
  ["PER-04", "2024-09-10", "2024-Q3", 3, 0.252, "Launch-paper top system", "Assistant task accuracy", "https://assistantbench.github.io/", "Original benchmark configuration."],
  ["PER-04", "2025-08-07", "2025-Q3", 7, 0.367, "GPT-5", "Assistant task accuracy", "https://hal.cs.princeton.edu/assistantbench", "Updated HAL leaderboard/configuration; system-level trend only."],
...
// Observations.
titleBand(obs, "A1:K2", "Normalized Benchmark Observations", "A3:K3", "Append-only evidence ledger. Raw dollars and Elo enter the report only after conversion against a fixed, sourced target or reference anchor.");
obs.getRange("A5:K5").values = [["Benchmark ID", "Benchmark Name", "Category", "Observed date", "Quarter", "Quarter index", "Score", "System / harness", "Score basis", "Source URL", "Notes"]];
