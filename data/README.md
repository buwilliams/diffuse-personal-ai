...
See [`../intent/05-operations/01-monthly-refresh.md`](../intent/05-operations/01-monthly-refresh.md) for the authoritative update procedure and [`../intent/02-model/05-data-structure.md`](../intent/02-model/05-data-structure.md) for the normalized schema.
